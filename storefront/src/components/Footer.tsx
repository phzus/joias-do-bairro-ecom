      ...
      <div className="container mx-auto px-6 relative z-10 flex flex-col items-center text-center">
        ...
        <div className="flex flex-col items-center gap-6 mb-16 w-full">
          ...
          <div className="flex gap-4 md:gap-6 justify-center">
            <a href="https://www.instagram.com/joisdobairro" target="_blank" className="group relative flex items-center justify-center w-14 h-14 bg-white/5 border border-white/10 rounded-full hover:bg-[#c8102e] hover:border-[#c8102e] hover:scale-110 transition-all duration-300">
              <Instagram size={20} className="text-white group-hover:text-white transition-colors" />
            </a>
            <a href="https://www.youtube.com/@joisdobairro" target="_blank" className="group relative flex items-center justify-center w-14 h-14 bg-white/5 border border-white/10 rounded-full hover:bg-[#c8102e] hover:border-[#c8102e] hover:scale-110 transition-all duration-300">
              <Youtube size={20} className="text-white group-hover:text-white transition-colors" />
            </a>
            <a href="https://www.tiktok.com/@joisdobairro" target="_blank" className="group relative flex items-center justify-center w-14 h-14 bg-white/5 border border-white/10 rounded-full hover:bg-[#c8102e] hover:border-[#c8102e] hover:scale-110 transition-all duration-300">
              <svg
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-4 mb-10">
          <Link
            to="/rastrear"
            className="flex items-center gap-2 text-[10px] font-black tracking-[0.3em] uppercase text-zinc-400 hover:text-[#c8102e] transition-colors"
          >
            <Package size={12} />
            Rastrear Pedido
          </Link>
          <Link
            to="/conta"
            className="text-[10px] font-black tracking-[0.3em] uppercase text-zinc-400 hover:text-[#c8102e] transition-colors"
          >
            Minha Conta
          </Link>
          <Link
        ...
        >
          <div className="w-px h-12 bg-white/20 group-hover:h-16 group-hover:bg-[#c8102e] transition-all duration-300"></div>
        ...
        <div className="w-full pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6 opacity-60 text-[9px] font-black tracking-[0.3em] uppercase">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="w-1 h-1 rounded-full bg-[#c8102e]"></span>
            <span className="text-[#c8102e]">Do Bairro pra você</span>
          </div>
        </div>
      </div>
    </footer>
