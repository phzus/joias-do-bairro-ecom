...
const ShippingQuote: React.FC<Props> = ({
  ...
  return (
    <div className="space-y-4">
        ...
        <div className="space-y-10">
          ...
          <div className="relative">
            <input
              ...
              className="w-full bg-transparent border-b py-3 pr-8 text-sm font-medium text-white placeholder:text-zinc-800 border-zinc-800 focus:border-[#c8102e] focus:outline-none transition-all"
      ...
      {error && showCepInput && (
        <div className="flex items-center gap-2 text-[#c8102e] text-[10px] font-medium">
          <AlertCircle size={12} />
          {error}
        </div>
      )}
