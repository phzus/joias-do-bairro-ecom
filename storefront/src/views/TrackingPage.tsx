    ...
    <div className="bg-[#0a0a0a] min-h-[80vh] text-white pt-12 pb-24">
      <div className="container mx-auto px-6 max-w-3xl">
        <div className="flex items-center gap-4 mb-12">
          <div className="w-10 h-10 border border-white/10 flex items-center justify-center rounded-full text-[#c8102e]">
            <Package size={18} />
          </div>
        ...
        <form onSubmit={onSearch} className="mb-12">
          ...
          <div className="flex gap-3">
            <input
              ...
              className="flex-1 bg-transparent border-b py-4 text-sm font-medium text-white placeholder:text-zinc-800 border-zinc-800 focus:border-[#c8102e] focus:outline-none transition-all"
              aria-label="Código de rastreio"
            />
            <button
              type="submit"
              disabled={loading || !code.trim()}
              className="px-8 py-4 bg-white text-black text-[10px] font-bold uppercase tracking-widest hover:bg-[#c8102e] hover:text-white transition-all disabled:opacity-40 disabled:cursor-not-allowed flex items-center gap-2"
            >
              {loading ? (
        ...
        <AnimatePresence mode="wait">
          {error && (
            <motion.div
              ...
              exit={{ opacity: 0 }}
              className="flex items-center gap-3 bg-[#c8102e]/10 border border-[#c8102e]/20 p-5 text-[#c8102e] rounded-sm"
            >
              <AlertCircle size={16} />
