  ...
  if (error || !product) {
    return (
      <div className="bg-[#050505] min-h-screen text-white flex flex-col items-center justify-center">
        <p className="text-[#c8102e] text-lg font-black uppercase tracking-widest mb-6">Produto Não Encontrado</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-20">
            ...
            >
              ...
              <AnimatePresence>
                {isProcessingIA && (
                  ...
                  >
                    <RefreshCw size={48} className="text-[#c8102e] animate-spin mb-6 md:mb-8" />
              ...
              {iaPreviewUrl && (
                <div className="absolute top-4 right-4 md:top-8 md:right-8 z-30 bg-[#c8102e] px-3 py-1.5 md:px-4 md:py-2 flex items-center gap-2 shadow-xl">
                ...
                {lore && (
                  ...
                  >
                    <div className="max-w-md">
                      <ShieldAlert className="mx-auto mb-6 md:mb-8 text-[#c8102e]" size={32} />
                      <h4 className="text-[10px] font-black uppercase tracking-[0.5em] text-[#c8102e] mb-4 md:mb-8">Lore Decodificado</h4>
            ...
            <div className="flex gap-3 md:gap-4 overflow-x-auto pb-4 scrollbar-hide">
              {/* <div className="relative">
                ...
                <button
                  ...
                  className="w-20 h-28 md:w-24 md:h-32 flex-shrink-0 border border-dashed border-zinc-800 flex flex-col items-center justify-center gap-3 md:gap-4 hover:border-[#c8102e] hover:bg-[#c8102e]/5 transition-all group"
              ...
              {images.map((img, idx) => (
                <button
                  ...
                  className={`relative w-20 h-28 md:w-24 md:h-32 flex-shrink-0 border transition-all duration-500 overflow-hidden ${selectedImage === idx && !iaPreviewUrl ? 'border-[#c8102e] scale-105 z-10' : 'border-zinc-900 opacity-40 hover:opacity-100'}`}
          ...
          <div className="lg:col-span-6 flex flex-col">
            <div className="mb-8 md:mb-10">
              <span className="text-[#c8102e] text-[9px] md:text-[10px] font-black uppercase tracking-[0.5em] mb-4 block">
              ...
              <div className="flex flex-col sm:flex-row sm:items-end justify-between border-b border-white/5 pb-6 md:pb-8 gap-6">
                {displayPrice && (
                  <div className="flex items-baseline gap-2">
                    <p className="text-4xl md:text-6xl lg:text-4xl font-black tracking-tighter text-[#c8102e] leading-none">
              ...
              <button
                ...
                className={`w-full py-6 md:py-8 flex items-center justify-center gap-4 md:gap-6 font-black uppercase text-[10px] md:text-xs tracking-[0.5em] md:tracking-[0.6em] transition-all duration-500 ${!selectedVariant
                  ...
                  : isAdding
                    ...
                    : 'bg-white text-black hover:bg-[#c8102e] hover:text-white shadow-2xl scale-100 active:scale-95'
                  }`}
              ...
              <div className="bg-zinc-950 p-6 md:p-10 border border-white/5 space-y-6">
                ...
                {product.material && (
                  <div className="flex items-center gap-4 text-[10px] md:text-xs font-black uppercase tracking-[0.2em]">
                    <Zap size={18} className="text-[#c8102e]" />
